...
interface GitHubActivity {
  id: string
  type: "push" | "create" | "pull_request" | "star" | "fork" | "release"
  repository: string
  message: string
  timestamp: string
  branch?: string
...
export function LiveGitHubActivity() {
  ...
  const recentActivity: GitHubActivity[] = [
    {
      id: "1",
      type: "push",
      ...
      branch: "main",
      url: "https://github.com/Bheeni14/customer-churn-prediction",
      language: "python"
    },
    {
      id: "2", 
      ...
      url: "https://github.com/Bheeni14/portfolio-website",
      language: "typescript",
    ...
    },
    {
      ...
      url: "https://github.com/Bheeni14/data-visualization-toolkit",
      language: "javascript"
    },
    {
      id: "4",
      ...
      url: "https://github.com/Bheeni14/machine-learning-notebooks",
      language: "jupyter"
    },
    {
      id: "5",
      ...
      branch: "develop",
      url: "https://github.com/Bheeni14/python-data-analysis",
      language: "python"
    },
    {
      id: "6",
      ...
      url: "https://github.com/Bheeni14/react-components-library",
      language: "typescript"
    }
  ]
  ...
  const filteredActivity = selectedFilter === "all" 
    ? recentActivity 
    : recentActivity.filter(activity => activity.type === selectedFilter)
  ...
  const totalCommits = recentActivity.filter(a => a.type === "push").length * 15 // Estimated
            ...
            <Card className="border-0 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800/80 dark:to-blue-900/20 backdrop-blur-lg shadow-lg mt-6">
              <CardContent className="p-6 text-center">
                ...
                <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white" asChild>
                  <a href="https://github.com/bheeni" target="_blank" rel="noopener noreferrer">
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Python", "TypeScript", "JavaScript", "Jupyter Notebook"].map((lang) => {
              const repoCount = repositories.filter(r => r.language === lang).length
              const percentage = (repoCount / repositories.length) * 100
              return (
