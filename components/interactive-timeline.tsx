        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Content card */}
              <Card
                className={`flex-1 border-0 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden ${
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(45deg, ${item.color}05, ${item.color}10, ${item.color}05)`,
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(45deg, transparent, ${item.color}08, transparent)`,
                  }}
                />
              </Card>
            </div>
